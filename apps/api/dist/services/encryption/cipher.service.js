 ...
 */
export function encryptField(plaintext, dek) {
 ...
 */
export function decryptField(payload, dek) {
    const decipher = createDecipheriv(ALGORITHM, dek, Buffer.from(payload.iv, 'base64'));
