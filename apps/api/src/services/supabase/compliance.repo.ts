...
export async function listPolicies(userId: string, accountId?: string): Promise<CompliancePolicy[]> {
...
export async function getPolicy(id: string, userId: string): Promise<CompliancePolicy | null> {
