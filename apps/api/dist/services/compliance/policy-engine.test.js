...
import { evaluateAction, evaluateActionDry, evaluateCondition, evaluateRuleDefinition, getFieldValue, } from './policy-engine.service.js';
...
describe('evaluateActionDry', () => {
    ...
    it('returns null for non-matching policy', async () => {
        ...
        const result = await evaluateActionDry(ctx, policy);
...
describe('evaluateAction', () => {
    ...
    it('returns ALLOW when no policies exist', async () => {
        ...
        supabaseModule.supabaseAdmin.from = mockFrom;
