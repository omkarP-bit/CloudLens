...
export async function scheduledActionsRoutes(fastify) {
    fastify.get('/api/scheduled-actions', async (request, reply) => {
    ...
    fastify.post('/api/scheduled-actions', async (request, reply) => {
        const user = request.user;
        const body = z.object({
    ...
    fastify.patch('/api/scheduled-actions/:id/toggle', async (request, reply) => {
        const user = request.user;
    ...
    fastify.delete('/api/scheduled-actions/:id', async (request, reply) => {
        const user = request.user;
        const { id } = request.params;
        try {
